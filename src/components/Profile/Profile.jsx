        ...
        <Modal isOpen={this.state.modal}>
          ...
          <ModalBody>
              ...
              <CardBody>
                ...
                <Button href={'https://mail.google.com/mail/?view=cm&fs=1&to=' + artistProfile['contact'] + '&su=Crescendo+User+Inquiry&body=Thank+you+for+choosing+Crescendo!'} style={{width:"100%"}}>Contact {artistProfile['artist']}</Button>              </CardBody>
          </ModalBody>
        </Modal>
      </div>
    );
